...
import java.util.Date;
                                                // klasi Reservation
public class Reservation implements Serializable{       // idiotites tou antikeimenou kratisis
    ...
    public String display(){                    // methodos gia tin emfanisi twn idiotitwn mias kratisis
       String dis=(id+" "+name+" "+surname+" "+tel+" "+checkin+" "+checkout+" "+roomtype+" "+breakfast+" "+price);
       return dis;
    }
}
